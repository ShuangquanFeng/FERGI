# Adapted from https://github.com/salesforce/BLIP and https://github.com/THUDM/ImageReward

MED_CONFIG_PATH = 'scores/blip_model/med_config.json'
...
from .blip_model.blip import load_checkpoint
from .blip_model.blip_pretrain import BLIP_Pretrain
...
class BLIPScore(nn.Module):
    def __init__(self, med_config=None, device='cpu'):
        super().__init__()
        self.device = device
